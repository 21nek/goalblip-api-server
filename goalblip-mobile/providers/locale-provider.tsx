...
// Supported locales
export const SUPPORTED_LOCALES = ['tr', 'en', 'es', 'de', 'it', 'zh-TW', 'zh-CN', 'ja', 'id', 'fr', 'ru', 'tl', 'ko', 'ar', 'pt'] as const;
...
export const LOCALE_LABEL_KEYS: Record<Locale, string> = {
  ...
  it: 'settings.localeNames.it',
  'zh-TW': 'settings.localeNames.zh-TW',
  'zh-CN': 'settings.localeNames.zh-CN',
  ja: 'settings.localeNames.ja',
  id: 'settings.localeNames.id',
  fr: 'settings.localeNames.fr',
  ru: 'settings.localeNames.ru',
  tl: 'settings.localeNames.tl',
  ko: 'settings.localeNames.ko',
  ar: 'settings.localeNames.ar',
  pt: 'settings.localeNames.pt',
};
...
export const LOCALE_NATIVE_META: Record<Locale, { nativeName: string; languageWord: string }> = {
  ...
  it: { nativeName: 'Italiano', languageWord: 'Lingua' },
  'zh-TW': { nativeName: '\u7e41\u9ad4\u4e2d\u6587', languageWord: '\u8a9e\u8a00' },
  'zh-CN': { nativeName: '\u7b80\u4f53\u4e2d\u6587', languageWord: '\u8bed\u8a00' },
  ja: { nativeName: '\u65e5\u672c\u8a9e', languageWord: '\u8a00\u8a9e' },
  id: { nativeName: 'Bahasa Indonesia', languageWord: 'Bahasa' },
  fr: { nativeName: 'Fran\u00e7ais', languageWord: 'Langue' },
  ru: { nativeName: '\u0420\u0443\u0441\u0441\u0441\u043a\u0438\u0439', languageWord: '\u042f\u0437\u044b\u043a' },
  tl: { nativeName: 'Tagalog', languageWord: 'Wika' },
  ko: { nativeName: '\ud55c\uad6d\uc5b4', languageWord: '\uc5b4\uc5b4' },
  ar: { nativeName: '\u0627\u0644\u0639\u0631\u0628\u064a\u0629', languageWord: '\u0627\u0644\u0644\u063a\u0629' },
  pt: { nativeName: 'Portugu\u00eas', languageWord: 'Idioma' },
};
